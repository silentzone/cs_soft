var appMid = new function(){};
appMid.init = function(flag){
	this.elemInit();
	// this.initSelect();
	if(flag=='true'){
...
appMid.disabledBasicElem = function(){
...
appMid.elemInit = function(){
	// 标签
	var arr = [{key:"国外教程",value: "101"},{key:"国内教程",value: "102"},{key:"综合培训",value: "103"},{key:"其它",value: "104"}];
    $("#chkbox_list").checklist(arr);
 
	var  $input = $("#t_radio").find("input");
	this.radioChk();
	$input.bind("change",function () {appMid.radioChk();});	
}
appMid.saveApp = function(){
...
appMid.appCatalogBo = function(dataBO){
